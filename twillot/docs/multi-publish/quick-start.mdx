...
1. Install Twillot Multi Publish extension for Chrome
2. Log in with your Google account after installation
3. Create or select a draft
4. Make sure you have logged in your target platforms
...
## Make sure you have logged in your target platforms

On the [Twillot Multi Publish](https://www.twillot.com/multi-publish/platforms?utm_source=docs) platform page, all supported platforms are displayed by default. 
Log in your target platforms to post articles.
